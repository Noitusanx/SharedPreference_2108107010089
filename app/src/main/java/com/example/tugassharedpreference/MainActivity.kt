...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val namaEt = findViewById<EditText>(R.id.namaMahasiswa)
        val jurusanEt = findViewById<EditText>(R.id.jurusanMahasiswa)
        val npmEt = findViewById<EditText>(R.id.npmMahasiswa)
